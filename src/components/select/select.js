export function setupCustomSelects() {
    ...
    customSelects.forEach(customSelect => {
        ...
        for (let i = 0; i < selectEl.length; i++) {
            if (selectEl.options[i].hasAttribute('hidden') || selectEl.options[i].hasAttribute('disabled')) {
                continue; // Pula a criação da div na lista suspensa se a option for hidden/disabled
            }
